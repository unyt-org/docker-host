...
import { Runtime, StaticScope } from "../runtime/runtime.js";

import { Logger } from "../utils/logger.js";
import { Endpoint, endpoint_name, Target, target_clause } from "../types/addressing.js";
import { context_kind, context_meta_getter, context_meta_setter, context_name } from "./legacy_decorators.js";
import { Type } from "../types/type.js";
import { getProxyFunction, getProxyStaticValue, Pointer, UpdateScheduler } from "../runtime/pointers.js";
import { Error as DatexError, ValueError } from "../types/errors.js";
...
import { DX_PERMISSIONS, DX_TYPE } from "../runtime/constants.js";
...
export class Decorators {
    ...
    static expose(value:any, name:context_name, kind:context_kind, is_static:boolean, is_private:boolean, setMetadata:context_meta_setter, getMetadata:context_meta_getter, params:[target_clause?] = []) {
...
function staticScopeClass(original_class:Class) {
