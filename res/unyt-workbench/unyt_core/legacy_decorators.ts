...
import { Decorators, METADATA } from "./datex_js_class_adapter.js";
...
type decorator_target = {[key: string]: any} & Partial<Record<keyof Datex.Addresses.Filter, never>> & Partial<Record<keyof Array<any>, never>>;
...
export function expose(...allow: (Datex.Addresses.Filter|Datex.Addresses.Target|Datex.Addresses.Not|string)[]):any
...
export function scope(...args) {
    return handleDecoratorArgs(args, Decorators.scope);
}

export function root_extension(target: any, name?: string, method?)
export function root_extension(...args): any {
    return handleDecoratorArgs(args, Decorators.root_extension);
}

export function root_variable(target: any, name?: string, method?)
export function root_variable(...args): any {
    return handleDecoratorArgs(args, Decorators.root_variable);
}

export function remote(...from: (Datex.Addresses.Filter|Datex.Addresses.Target|Datex.Addresses.Not|string)[]):any
...
export function allow(...allow: (Datex.Addresses.Filter|Datex.Addresses.Target|Datex.Addresses.Not|string)[]):any
export function allow(...args) {
    return handleDecoratorArgs(args, Decorators.allow);
}

export function to(...to: (Datex.Addresses.Filter|Datex.Addresses.Target|Datex.Addresses.Not|string)[]):any
...
export function sync(type:string|Datex.Type):any
...
export function template(type:string|Datex.Type):any
...
export function anonymous(...args) {
    ...
    if (args[0]==undefined || args[0] == null || (args[1]===undefined && args[0] && typeof args[0] == "object")) {
        return Datex.Pointer.create(null, args[0], /*TODO*/false, undefined, false, true).value;
    }
    // decorator
