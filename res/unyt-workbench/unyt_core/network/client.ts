...
import { datex_meta, dxb_header } from "../utils/global_types.js";
import { Datex, scope, meta, expose, remote} from "../datex.js";
import { fetch } from "../utils/utils.js";
import { Disjunction, Logical } from "../datex_all.js";
...
class WebsocketStreamClientInterface extends CommonInterface {
    ...
    protected async connect_node_js(): Promise<boolean>{
        ...
        this.wss.on('data', (dmx_block:Buffer) => {
            InterfaceManager.handleReceiveBlock(new Uint8Array(dmx_block).buffer, this.endpoint);
        });
