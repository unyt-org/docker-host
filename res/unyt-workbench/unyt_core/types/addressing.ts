...
import { ValueConsumer } from "./abstract_types.js";
import { SecurityError, ValueError } from "./errors.js";
import { Tuple } from "./tuple.js";
import { Compiler } from "../compiler/compiler.js";
import { datex_scope } from "../utils/global_types.js";
import { buffer2hex, hex2buffer } from "../utils/utils.js";
import { clause, Disjunction } from "./logic.js";
...
export type endpoint_by_endpoint_name<name extends endpoint_name> = 
    ...
    (name extends filter_target_name_person ? Person :
    (name extends filter_target_name_bot ? Bot : never
    )));
