...
import type { Pointer, Value } from "../runtime/pointers.js"
import type { BinaryCode } from "../compiler/binary_codes.js"
import type { StreamConsumer } from "../types/abstract_types.js"
import { ProtocolDataType } from "../compiler/protocol_types"
import { Endpoint, Target, target_clause } from "../types/addressing.js"
import { compiler_options, PrecompiledDXB } from "../compiler/compiler.js"
import { cnf, Connective, Disjunction } from "../types/logic.js"
import { NOT_EXISTING } from "../datex_all.js"
...
export type datex_scope = {
    ...
    meta: datex_meta,
    remote: {insert?:object, sign?:boolean, encrypt?:boolean, eos?:boolean, type?:ProtocolDataType}, // outgoing remote configuration
