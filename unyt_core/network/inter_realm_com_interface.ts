import { LOCAL_ENDPOINT, Endpoint } from "../types/addressing.js";
import { Runtime } from "../runtime/runtime.js";
import { Logger } from "../utils/logger.js";
import InterfaceManager, { CommonInterface } from "./client.js";
import { f } from "../datex_short.js";
import { client_type } from "../utils/global_values.js";


const logger = new Logger("Inter Realm Com")

// @ts-ignore
const BroadcastChannel = <typeof globalThis.BroadcastChannel> (client_type=="node" ? (await import("node:worker_threads")).BroadcastChannel : globalThis.BroadcastChannel);
...
export class InterRealmCommunicationInterface extends CommonInterface {
    ...
    static addDataChannelListeners(){
        ...
        if (this.rxChannel1) this.rxChannel1.addEventListener("message", event => {
            ...
            InterfaceManager.handleReceiveBlock(event.data, null);
        })
