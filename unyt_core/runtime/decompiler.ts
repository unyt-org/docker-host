...
import { base64ToArrayBuffer, BinaryCode, Endpoint, Logger, Pointer, Runtime, Target, Type, Quantity, Disjunction, Connective } from "../datex_all.js";
			...
			loop: while (true) {
				...
				switch (token) {
					...
					case BinaryCode.INIT_LABEL: { 
						was_value = false;
						let name = extractVariableName();
						let jmp_index = data_view.getUint32(current_index);
						current_index += Uint32Array.BYTES_PER_ELEMENT;
